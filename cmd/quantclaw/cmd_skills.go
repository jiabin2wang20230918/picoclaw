...
func skillsHelp() {
	...
	fmt.Println("  quantclaw skills list")
	fmt.Println("  quantclaw skills install sipeed/quantclaw-skills/weather")
	fmt.Println("  quantclaw skills install-builtin")
	fmt.Println("  quantclaw skills list-builtin")
	fmt.Println("  quantclaw skills remove weather")
	fmt.Println("  quantclaw skills install --registry clawhub github")
}
...
func skillsInstallCmd(installer *skills.SkillInstaller, cfg *config.Config) {
	if len(os.Args) < 4 {
		fmt.Println("Usage: quantclaw skills install <github-repo>")
		fmt.Println("       quantclaw skills install --registry <name> <slug>")
		return
	}
	...
	if os.Args[3] == "--registry" {
		if len(os.Args) < 6 {
			fmt.Println("Usage: quantclaw skills install --registry <name> <slug>")
			fmt.Println("Example: quantclaw skills install --registry clawhub github")
			return
		}
...
func skillsInstallBuiltinCmd(workspace string) {
	builtinSkillsDir := "./quantclaw/skills"
...
func skillsListBuiltinCmd() {
	...
	builtinSkillsDir := filepath.Join(filepath.Dir(cfg.WorkspacePath()), "quantclaw", "skills")
