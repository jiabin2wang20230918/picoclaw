...
import (
	...
	anthropicprovider "github.com/sipeed/quantclaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: quantclaw auth login --provider anthropic")
		}
